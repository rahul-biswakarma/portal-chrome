...
export const ThemeEditorView: React.FC<ThemeEditorProps> = ({ initialConfig, onConfigChange }) => {
  const {
    config,
    validation,
    isValid,
    ...
    <div className="h-full flex flex-col bg-background text-foreground">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide">
        <div className="p-6 space-y-8">
          {/* Color Settings */}
          <div>
            <ColorSettings colors={config.colors} onColorsChange={updateColors} />
          </div>
          ...
          {/* Font Settings */}
          <div>
            <FontSettings fonts={config.fonts} onFontsChange={updateFonts} />
          </div>
          ...
          {/* Layout Settings */}
          <div>
            <LayoutSettings layout={config.layout} onLayoutChange={updateLayout} />
          </div>
