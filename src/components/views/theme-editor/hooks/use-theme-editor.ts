...
// import { useAppContext } from '@/contexts'; // DISABLED - not auto-applying CSS
import type {
  ThemeConfig,
  FontConfig,
  ColorConfig,
...
export const useThemeEditor = (
  ...
  // const { setCssContent } = useAppContext(); // DISABLED - not auto-applying CSS
  ...
  // Debounced CSS application - DISABLED
  ...
  // Apply CSS changes - DISABLED to prevent auto-applying theme CSS to editor
  // useEffect(() => {
  //   if (isValid) {
  ...
  // CSS regeneration - DISABLED to prevent auto-applying theme CSS to editor
  const regenerateCSS = useCallback(() => {
    ...
    // setCssContent(newCSS); // DISABLED
    console.log('Generated CSS:', newCSS); // Log for debugging instead
  }, [config]);
