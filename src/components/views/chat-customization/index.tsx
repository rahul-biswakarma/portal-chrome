...
import { MessageCircle, Settings, History, Sparkles } from 'lucide-react';
...
// Simplified types for the initial implementation
    ...
    const initializeSession = async () => {
      const session: ChatSession = {
        ...
        messages: [{
          id: `msg_${Date.now()}`,
          type: 'system',
          content: 'Welcome! I can help modify your website styles. Describe what you\'d like to change, and I\'ll generate the appropriate CSS modifications.',
          timestamp: Date.now()
        }],
        createdAt: Date.now(),
        updatedAt: Date.now()
