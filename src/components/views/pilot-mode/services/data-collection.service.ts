        ...
        func: () => {
          const extractElementData = (element: Element): PortalElement | null => {
            ...
            const tailwindClasses = classList.filter(cls => 
              ...
              (
                // Layout
                cls.startsWith('flex') || cls.startsWith('grid') || cls.startsWith('block') ||
                cls.startsWith('inline') || cls.startsWith('hidden') || cls.startsWith('visible') ||
                // Spacing
                cls.startsWith('p-') || cls.startsWith('m-') || cls.startsWith('px-') || 
                cls.startsWith('py-') || cls.startsWith('mx-') || cls.startsWith('my-') ||
                cls.startsWith('pt-') || cls.startsWith('pb-') || cls.startsWith('pl-') || 
                cls.startsWith('pr-') || cls.startsWith('mt-') || cls.startsWith('mb-') ||
                cls.startsWith('ml-') || cls.startsWith('mr-') || cls.startsWith('space-') ||
                // Sizing
                cls.startsWith('w-') || cls.startsWith('h-') || cls.startsWith('min-w-') ||
                cls.startsWith('min-h-') || cls.startsWith('max-w-') || cls.startsWith('max-h-') ||
                // Colors
                cls.startsWith('bg-') || cls.startsWith('text-') || cls.startsWith('border-') ||
                cls.startsWith('ring-') || cls.startsWith('divide-') || cls.startsWith('placeholder-') ||
                // Typography
                cls.startsWith('font-') || cls.startsWith('text-') || cls.startsWith('leading-') ||
                cls.startsWith('tracking-') || cls.startsWith('uppercase') || cls.startsWith('lowercase') ||
                cls.startsWith('capitalize') || cls.startsWith('normal-case') ||
                // Borders
                cls.startsWith('rounded') || cls.startsWith('border') || cls.includes('border-') ||
                // Effects
                cls.startsWith('shadow') || cls.startsWith('opacity-') || cls.startsWith('backdrop-') ||
                // Positioning
                cls.startsWith('relative') || cls.startsWith('absolute') || cls.startsWith('fixed') ||
                cls.startsWith('sticky') || cls.startsWith('static') || cls.startsWith('top-') ||
                cls.startsWith('bottom-') || cls.startsWith('left-') || cls.startsWith('right-') ||
                cls.startsWith('inset-') || cls.startsWith('z-') ||
                // Display
                cls.startsWith('table') || cls.startsWith('flow-') || cls.startsWith('contents') ||
                // Overflow
                cls.startsWith('overflow-') || cls.startsWith('overscroll-') ||
                // Transform
                cls.startsWith('transform') || cls.startsWith('rotate-') || cls.startsWith('scale-') ||
                cls.startsWith('translate-') || cls.startsWith('skew-') ||
                // Transition
                cls.startsWith('transition') || cls.startsWith('duration-') || cls.startsWith('ease-') ||
                cls.startsWith('delay-') || cls.startsWith('animate-')
              )
            );
            ...
            portalClasses.forEach((portalClass) => {
              if (!styles[portalClass]) {
                ...
                props.forEach((prop) => {
                  ...
                  if (value && value !== '' && value !== 'initial' && value !== 'auto' && value !== 'none') {
